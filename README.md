...
HiDEF-seq analysis also requires standard germline sequencing data for filtering germline variants, which we also recommend to sequence on PacBio instruments.
